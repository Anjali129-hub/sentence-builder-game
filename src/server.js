...
const questions = [
  ...
  {
    questionId: "11",
    question: "The _____________ strategy _____________ the company's market share, _____________ revenue streams and _____________ customer engagement.",
    options: ["Boosted", "Innovative", "Diversifying", "Elevated"],
    correctAnswer: ["Innovative", "Boosted", "Diversifying", "Elevated"]
  },
  {
    questionId: "12",
    question: "The _____________ use of renewable energy _____________ carbon emissions, _____________ environmental health and _____________ a sustainable future.",
    options: ["Ensures", "Enhanced", "Growing", "Reduces"],
    correctAnswer: ["Growing", "Reduces", "Enhanced", "Ensures"]
  },
  {
    questionId: "13",
    question: "The _____________ of e-learning platforms _____________ access to education, _____________ learning outcomes and _____________ lifelong learning habits.",
    options: ["Encouraging", "Adoption", "Improving", "Facilitated"],
    correctAnswer: ["Adoption", "Facilitated", "Improving", "Encouraging"]
  },
  {
    questionId: "14",
    question: "The _____________ design of the app _____________ user navigation, _____________ user retention and _____________ daily active users.",
    options: ["Intuitive", "Increased", "Simplifies", "Boosting"],
    correctAnswer: ["Intuitive", "Simplifies", "Boosting", "Increased"]
  },
  {
    questionId: "15",
    question: "The _____________ shift to remote work _____________ productivity, _____________ work-life balance and _____________ future workplace strategies.",
    options: ["Enabling", "Improved", "Shaping", "Sudden"],
    correctAnswer: ["Sudden", "Improved", "Enabling", "Shaping"]
  }
];

// Serve the questions dynamically
